...
export function PropertyCardB({ listing }: { listing: PropertyListing }) {
  ...
  return (
    <article className="group cursor-pointer overflow-hidden rounded-lg transition-shadow duration-200 hover:shadow-[0_2px_8px_rgba(0,0,0,0.15)]">
      ...
      <div className="px-2 py-2">
        ...
        {/* Neighborhood Vibe Line — Variant B feature */}
        {listing.vibeLine && (
          <p className="mt-1 truncate text-[12px] italic text-[#767680]">
            {listing.vibeLine}
          </p>
        )}
